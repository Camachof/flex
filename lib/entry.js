...
function dragstartHandler(e) {
  ...
  const yPos = parseInt(style.getPropertyValue('bottom'), 10) - (window.innerHeight - e.clientY);
...
function dropHandler(e){
  ...
  toolbar.style.bottom = (window.innerHeight - e.clientY) + parseInt(offset[1],10) + 'px';
